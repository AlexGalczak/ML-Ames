...
house_price %>% 
  ggplot(aes(x=Age, y=SalePrice, color=SalePriceShort)) + geom_point()
...
```{r   Density Plots of Ames & Each Neighborhood}

clean = read.csv('data/Ames_HousePrice_cleaned.csv')

clean

```

```{r  Neighborhood price density vs Rest of Ames}
